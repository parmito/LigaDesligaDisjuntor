...
#define EVENT_SD_READWRITE_CONFIG      				(unsigned char)19
 /* EVENTS DEBUG*/
...
#define EVENT_APP_DISARMING										(unsigned char)10
...
#define EVENT_HTTPCLI_POLLING						(unsigned char)10
...
#define	SRC_APP    	6
#define	SRC_REMOTE 	7
#define SRC_BLE		0  /*Uninstall*/
#define SRC_HTTPCLI 9
#define SRC_HTTPSRV 10
...
#define httcliQUEUE_LENGTH					( 10)
 ...
 typedef struct{
 	...
 	char cState[RX_BUF_SIZE_REDUCED >>2];
 }tstConfiguration;
